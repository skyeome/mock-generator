...
export function FormatOptions({ format, options, onChange }: FormatOptionsProps) {
  ...
  if (format === 'json') {
    return (
      <div className="p-4 bg-card border border-border rounded-lg">
        <h3 className="text-sm font-medium text-foreground mb-3">JSON Options</h3>
        <div className="space-y-3">
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 bg-muted text-foreground text-sm rounded border border-border focus:border-primary focus:outline-none"
            >
  ...
  if (format === 'csv') {
    return (
      <div className="p-4 bg-card border border-border rounded-lg">
        <h3 className="text-sm font-medium text-foreground mb-3">CSV Options</h3>
        <div className="space-y-3">
          <div>
            <label className="block text-xs text-muted-foreground mb-1">
              Delimiter
          ...
          <div className="flex items-center">
            ...
            />
            <label htmlFor="csv-headers" className="ml-2 text-sm text-foreground">
              Include headers
            </label>
          </div>
        </div>
  ...
  if (format === 'sql') {
    return (
      <div className="p-4 bg-card border border-border rounded-lg">
        <h3 className="text-sm font-medium text-foreground mb-3">SQL Options</h3>
        <div className="space-y-3">
          <div>
            <label className="block text-xs text-muted-foreground mb-1">
              Table Name
  ...
  if (format === 'typescript') {
    return (
      <div className="p-4 bg-card border border-border rounded-lg">
        <h3 className="text-sm font-medium text-foreground mb-3">TypeScript Options</h3>
        <div className="space-y-3">
          <div>
            <label className="block text-xs text-muted-foreground mb-1">
              Interface Name
